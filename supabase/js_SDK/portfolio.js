...
function readArtistsCsv() {
    return new Promise((resolve, reject) => {
        ...
        fs.createReadStream('./supabase/generated_csv/artist.csv')
            .pipe(csv())
            .on('data', (row) => {
                profiles.push({
...
function readPublicUrlCsv() {
    return new Promise((resolve, reject) => {
        ...
        fs.createReadStream('./supabase/generated_csv/public_urls.csv')
            .pipe(csv())
            .on('data', (row) => {
                publicUrls.push({
                    place_id: row.place_id,
...
const portfolioCsvWriter = createCsvWriter({
    path: './supabase/generated_csv/portfolio.csv',
    header: [
...
function readNailTagsCsv() {
    return new Promise((resolve, reject) => {
        ...
        fs.createReadStream('./supabase/generated_csv/nail_tags.csv')
            .pipe(csv())
            .on('data', (row) => {
                nailTags.push({
                    filename: row.filename,
